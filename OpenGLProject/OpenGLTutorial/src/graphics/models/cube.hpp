...
public:
    ...
    char texturename[100] = "assets/texture.png";
    void setTexturename(char texturenames[100])
    {
        for (int id = 0; id < 100; id++)
            texturename[id] = texturenames[id];
    }
	void init() {
		int noVertices = 36;
        ...
        Texture tex(texturename, "material.diffuse");
        tex.load();
        Texture tex_specular(texturename, "material.ambient");
        tex_specular.load();
